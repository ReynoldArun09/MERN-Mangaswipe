  ...
  return (
    ...
    <section className='text-white w-[85%] xl:w-[70%] mx-auto mb-8'>
      ...
      <div className="my-[25px]">
        <p>
          mangaswipe.com respects the intellectual property of others.
          mangaswipe.com takes matters of Intellectual property very seriously
          ...
          us. If you believe that your copyrighted work has been copied in a way
          ...
          to be removed. We will not accept links to only search results, as
          they do not identify any item that may link to material infringing
          your work and copyright. You must identify individual items in the
          search results that you wish us to remove. If you send a link to
          another page, please describe which materials are under copyright
          protection. Information reasonably sufficient to permit the service
          ...
          must be submitted as a written, faxed, or emailed notification.
        </p>
      </div>
    </section>
    </>
